import { CurrencyAmount, Ether, Token, WETH9 } from '@taraswap/sdk-core'
  ...
  describe('pure V3', () => {
    ...
    it('wraps ether input for exact input single hop', () => {
      expect(encodeMixedRouteToPath(route_weth_V3_0)).toEqual(
        '0x5745cc77c362d459b78bc014d8940c2c98e08c54000bb80000000000000000000000000000000000000001'
      )
    })

    it('wraps ether input for exact input multihop', () => {
      expect(encodeMixedRouteToPath(route_weth_V3_0_V3_1)).toEqual(
        '0x5745cc77c362d459b78bc014d8940c2c98e08c54000bb80000000000000000000000000000000000000001000bb80000000000000000000000000000000000000002'
      )
    })

    it('wraps ether output for exact input single hop', () => {
      expect(encodeMixedRouteToPath(route_0_V3_weth)).toEqual(
        '0x0000000000000000000000000000000000000001000bb85745cc77c362d459b78bc014d8940c2c98e08c54'
      )
    })

    it('wraps ether output for exact input multihop', () => {
      expect(encodeMixedRouteToPath(route_0_V3_1_V3_weth)).toEqual(
        '0x0000000000000000000000000000000000000001000bb80000000000000000000000000000000000000002000bb85745cc77c362d459b78bc014d8940c2c98e08c54'
      )
    })
  })
  ...
  describe('pure V2', () => {
    ...
    it('wraps ether input for exact input single hop', () => {
      expect(encodeMixedRouteToPath(route_weth_V2_0)).toEqual(
        '0x5745cc77c362d459b78bc014d8940c2c98e08c548000000000000000000000000000000000000000000001'
      )
    })

    it('wraps ether input for exact input multihop', () => {
      expect(encodeMixedRouteToPath(route_weth_V2_0_V2_1)).toEqual(
        '0x5745cc77c362d459b78bc014d8940c2c98e08c5480000000000000000000000000000000000000000000018000000000000000000000000000000000000000000002'
      )
    })

    it('wraps ether output for exact input single hop', () => {
      expect(encodeMixedRouteToPath(route_0_V2_weth)).toEqual(
        '0x00000000000000000000000000000000000000018000005745cc77c362d459b78bc014d8940c2c98e08c54'
      )
    })

    it('wraps ether output for exact input multihop', () => {
      expect(encodeMixedRouteToPath(route_0_V2_1_V2_weth)).toEqual(
        '0x000000000000000000000000000000000000000180000000000000000000000000000000000000000000028000005745cc77c362d459b78bc014d8940c2c98e08c54'
      )
    })
  })
  ...
  describe('mixed route', () => {
    it('packs them for exact input v3 -> v2 with wrapped ether output', () => {
      expect(encodeMixedRouteToPath(route_0_V3_1_V2_weth)).toEqual(
        '0x0000000000000000000000000000000000000001000bb800000000000000000000000000000000000000028000005745cc77c362d459b78bc014d8940c2c98e08c54'
      )
    })

    it('packs them for exact input v3 -> v2 -> v2', () => {
      expect(encodeMixedRouteToPath(route_0_V3_weth_V2_1_V2_2)).toEqual(
        '0x0000000000000000000000000000000000000001000bb85745cc77c362d459b78bc014d8940c2c98e08c5480000000000000000000000000000000000000000000028000000000000000000000000000000000000000000003'
      )
    })

    it('packs them for exact input v3 -> v3 -> v2', () => {
      expect(encodeMixedRouteToPath(route_0_V3_1_v3_weth_V2_2)).toEqual(
        '0x0000000000000000000000000000000000000001000bb80000000000000000000000000000000000000002000bb85745cc77c362d459b78bc014d8940c2c98e08c548000000000000000000000000000000000000000000003'
      )
    })
  })
})
