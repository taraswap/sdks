import { Ether, Token, WETH9 } from '@taraswap/sdk-core'
...
describe('#encodeRouteToPath', () => {
  ...
  it('wraps ether input for exact output multihop', () => {
    expect(encodeRouteToPath(route_weth_0_1, true)).toEqual(
      '0x0000000000000000000000000000000000000002000bb80000000000000000000000000000000000000001000bb85745cc77c362d459b78bc014d8940c2c98e08c54'
    )
  })
  ...
  it('wraps ether output for exact output multihop', () => {
    expect(encodeRouteToPath(route_0_1_weth, true)).toEqual(
      '0x5745cc77c362d459b78bc014d8940c2c98e08c54000bb80000000000000000000000000000000000000002000bb80000000000000000000000000000000000000001'
    )
  })
})
